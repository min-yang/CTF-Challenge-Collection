...
stack_address = u64(data[18:] + b'\0\0') - stack_offset
print(stack_address)
...
base_address = main55_true_addr - main55_offset_addr
...
string_r = 0x0000000000000587 + base_address
string_flag = stack_address
